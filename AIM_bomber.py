...
logo2= ('''
  __  __ ___ _____ _   _ _      __     ___    ___ 
 |  \/  |_ _|_   _| | | | |     \ \   / / \  |_ _|
 | |\/| || |  | | | | | | |      \ \ / / _ \  | | 
 | |  | || |  | | | |_| | |___    \ V / ___ \ | | 
 |_|  |_|___| |_|  \___/|_____|    \_/_/   \_\___|
                                                                           
\033[1;36m============================================================

\033[1;92m[+] AUTHOR       :   ALTALIMUL ISLAM MITUL 
\x1b[1;92m[+] FACEBOOK     :   ITz Mitul Bro 
\x1b[1;92m[+] GITHUB       :   Mitul166
\x1b[1;12m[+] FB GROUP     :   Bolen ki?
\033[1;92m[+] TOOLS        :   SMS BOMBER (MITUL VAI)
...
print(logo2)
x="XAK"
print(w+"[~] For username & password must follow the github.")
os.system('xdg-open https://github.com/MITUL-588')

user=str(input(f"\n\n{w}USERNAME {r}=>{y} "))
pas=str(input(f"{w}PASSWORD {r}=>{y} "))
rp= 'mitul '
x = 'vai'
if 'mitul'==user and 'vai '==pas:
        Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL  ")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t\t   {w}<{r}/{w}> {g}Always Stay With AIM ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://www.facebook.com/itz.mitul.bro")

# Request
print(w+"[~] MITUL VAI ALWAYS BRAND")
print(f"\n\t      {ran},----------------------------------,")
